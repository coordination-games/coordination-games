...
6. **Communication matters exactly where defection pays.** OATHBREAKER (pair off, swear a pledge, independently honor or cash it in) is the sharper test of finding 4 — betrayal is explicitly profitable there, unlike Tragedy. Same chat-vs-silent split, n=3/arm, 4 seats/game, 0/24 seat mortality: with chat, 98.6% of oaths were kept (71/72) and the judge flagged 5 incidents (2 betrayals); silent, 77.1% kept (37/48) and 11 incidents (7 betrayals). Chat tables also formed more coordination pacts (5 vs 3). This is the contrast Tragedy couldn't show — tacit coordination through visible state is enough when nothing's at stake, but a talk channel is what holds a table honest once defection has a payoff. Live on `/story` (§6).
