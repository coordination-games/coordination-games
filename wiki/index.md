...
- [Campaign Console](development/campaign-console.md) — local dashboard over the harness: spec builder, live SSE runs, judge-report viewer, model comparison; wraps the coga-harness CLI, reads runs/out/
